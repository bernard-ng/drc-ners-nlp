...
from drc_names_classifier.utils import (
    NameView,
    coerce_name_view,
    name_view_series,
...
# These persisted BLAKE2 namespaces intentionally retain their original values so a
# package rename cannot silently move records between deterministic study partitions.
