...
from drc_names_classifier.config import (
...
app = typer.Typer(
    help="Run controlled DRC name-classification experiments.",
...
def experiments_train(
    ...
    from drc_names_classifier.experiments import ExperimentBuilder, ExperimentRunner
